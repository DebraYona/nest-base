...
This project is an example of implementation of a user **email authentication** with [Nestjs](https://nestjs.com/) v7.6.13, [MongoDB](https://www.mongodb.com/) and [PassportJs](http://www.passportjs.org)
